...
export class PostsController extends BaseController {
	...
	private initializeRoutes() {
		...
		this.router.post(this.path, ValidationMiddleware(CreatePostDto), this.createSinglePost);
	...
	async getPostById(req: express.Request, res: express.Response, next: express.NextFunction) {
		const { id } = req.params;
	...
	async updateSinglePost(req: express.Request, res: express.Response, next: express.NextFunction) {
		const { id } = req.params;
	...
	async deleteSinglePost(req: express.Request, res: express.Response, next: express.NextFunction) {
		const { id } = req.params;
